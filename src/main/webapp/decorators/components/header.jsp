					...
					<li class="nav-item dropdown"><a href="#account_menu"
						...
						<div id="account_menu" class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-item-text dropdown-item-text--lh">
								<div>
									Xin Chao <strong>${email}</strong>
								</div>
<%-- 								<div>${email}</div> --%>
							</div>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item active"
								href="<c:url value="<%=UrlConst.HOME%>" />"> Dashboard </a> <a
								class="dropdown-item"
								href="<c:url value="<%=UrlConst.USER_PROFILE%>" />"> My
								profile </a> <a class="dropdown-item"
								href="<c:url value="<%=UrlConst.USER_UPDATE%>" />"> Edit
								account </a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item"
								href="<c:url value="<%=UrlConst.LOGOUT%>" />">Logout</a>
						</div></li>
				</ul>
			</div>
		</div>
